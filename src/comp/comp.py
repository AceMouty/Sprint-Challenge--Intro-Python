...
c = [obj.name for obj in humans if obj.name[0] in letter_range]
print(c)
...
e = [f"{obj.name}-{obj.age}" for obj in humans]
print(e)
...
f = [(obj.name, obj.age) for obj in humans if obj.age in range(27, 33)]
print(f)
